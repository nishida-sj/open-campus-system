...
export async function GET(
  ...
  try {
    ...
    console.log('[DEBUG] GET /api/[tenant]/admin/users - Current user:', {
      exists: !!currentUser,
    ...
    console.error('GET /api/[tenant]/admin/users error:', error);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.error('POST /api/[tenant]/admin/users error:', error);
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    );
