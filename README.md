...
- **統計ダッシュボード**: 申込状況の可視化
- **申込者一覧**: 詳細な申込情報の表示
- **申込確定管理**: チェックボックス一括確定、個別確定
- **CSV一括確定**: Excelで編集して100名規模を2〜3分で一括確定
...
 f o r c e   r e d e p l o y   2 0 2 5 - 1 1 - 1 0 T 1 5 : 1 4 : 0 0  
 f o r c e   r e d e p l o y   2 0 2 5 - 1 1 - 1 0 T 1 5 : 4 8 : 0 2  
 f o r c e   r e d e p l o y   2 0 2 5 - 1 1 - 1 0 T 1 5 : 4 9 : 4 3  
