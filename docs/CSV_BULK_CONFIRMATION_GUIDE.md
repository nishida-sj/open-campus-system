...
**ダウンロードされるCSVファイル**:
```csv
申込者ID,氏名,ふりがな,学校名,学年,メールアドレス,候補,確定日程,確定コース,確定
abc-123-def,田中太郎,たなかたろう,〇〇高等学校,3年,tanaka@example.com,第1候補,2025-12-15,工学部体験,
def-456-ghi,佐藤花子,さとうはなこ,△△高等学校,2年,sato@example.com,第2候補,2025-12-22,医学部体験,
```
...
abc-123-def,田中太郎,たなかたろう,〇〇高等学校,3年,tanaka@example.com,第1候補,2025-12-15,工学部体験,○
def-456-ghi,佐藤花子,さとうはなこ,△△高等学校,2年,sato@example.com,第2候補,2025-12-22,医学部体験,○
ghi-789-jkl,鈴木一郎,すずきいちろう,〇〇高等学校,3年,suzuki@example.com,第1候補,2025-12-15,工学部体験,
```
↑ 田中さんと佐藤さんのみ確定される
...
| 氏名 | - | 申込者の氏名（参照用） | ❌ 編集不可 |
| ふりがな | - | 申込者のふりがな（参照用） | ❌ 編集不可 |
| 学校名 | - | 申込者の学校名（参照用） | ❌ 編集不可 |
| 学年 | - | 申込者の学年（参照用） | ❌ 編集不可 |
| メールアドレス | - | 申込者のメールアドレス（参照用） | ❌ 編集不可 |
| 候補 | - | 第1候補、第2候補など（参照用） | ❌ 編集不可 |
| 確定日程 | ✅ | 確定する日程 | ✅ 編集可能 |
| 確定コース | - | 確定するコース | ✅ 編集可能 |
| 確定 | ✅ | `○` を入力すると確定対象 | ✅ 編集必須 |
